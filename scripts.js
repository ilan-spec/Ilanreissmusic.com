// Audio files array with correct capitalization
const audioTracks = [
    "2 part shit.mp3",
    "42 cent.mp3",
    "67.mp3",
...
[Previous JavaScript code continues with the following changes:]

// Update the audio path to use capital 'A'
function createTrackList(tracks) {
    ...
    tracks.forEach(track => {
        ...
        trackItem.addEventListener('click', async () => {
            try {
                // Use capital 'A' in the audio path
                ...
                alert(error.message || 'Error playing audio. Please check if the audio file exists in the Audio folder.');
            }
        });
